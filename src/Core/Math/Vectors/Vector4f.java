...
import Core.Math.Transform.Quaternion4;
...
public class Vector4f
{
	...
	public Vector4f Rotate(Quaternion4 rotation)
	{
		Quaternion4 conjugate = rotation.Conjugate();

		Quaternion4 w = rotation.Mul(this).Mul(conjugate);
